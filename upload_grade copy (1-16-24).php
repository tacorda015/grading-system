...
$(document).ready(function () {
    ...
    $('#gradingSession').on('change', function () {
        ...
        table.ajax.url("./tables/StudentGradeFetch.php?UserAccountId=<?php echo $UserAccountId; ?>&currentSubjectId=<?php echo $currentSubjectId ?>&currentSelectedSessionId=" + currentSelectedSessionId).load();
