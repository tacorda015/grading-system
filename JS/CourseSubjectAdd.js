const addInputFields = $(
  'input[name="addCourseName"], input[name="addSubjectName"], input[name="addSyStart"], input[name="addSyEnd"], input[name="addMeetingDay"], input[name="addMeetingTimeStart"], input[name="addMeetingTimeEnd"], input[name="addSubjectRoom"]'
);
...
$('#addCourseSubject').on('click', function (e) {
  ...
  var formData = {
    ...
    addSubjectTitle: $('#addSubjectTitle').val(),
    addSubjectTeacher: $('#addSubjectTeacher').val(),
    addCourseSubjectProgramHead: $('#addCourseSubjectProgramHead').val(),
    addTeacherId: $('#addTeacherId').val(),
    addSyStart: $('#addSyStart').val(),
    addSyEnd: $('#addSyEnd').val(),
    addSySemester: $('#addSySemester').val(),
